...
html_theme_options = {
    "repository_url": "https://github.com/hot-dogs/whots18-data-report",
...
# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
    ('index', 'whots18-data-report.tex',
     u'WHOTS-18: Data Report',
...
epub_copyright = f'2024-11-06-{datetime.now().year}, Fernando Carvalho Pacheco'
